...
<!DOCTYPE html>
<body>
	<center><i class="fa fa-unlock mine"></i><br><h3 style="color:#3399cc;font-family:lucida sans;">Login Area</h3></center>
	<center>
		<form action="check_login.php" method="post">
	<input type="text" placeholder="UserId: Ex:N130010" name="user" id="userid" minlength="7" autofocus required><br>
	<input type="password" placeholder="Password: ******" name="pass" id="pass" minlength="5" required><br>
