...
if(isset($_POST['pages'])):
	$resultsPerPage=10;
	$paged=$_POST['pages'];
$sql="SELECT * FROM videos where category='$category' ORDER BY id ASC";
if($paged>0){
...
<li class="loadbutton2"><button class="loadmorevideos2" data-page=<?php echo $paged+1;?>>Load More</button></li>
<?php
}
endif;
?>