...
<!DOCTYPE html>
<body>
	<center><i class="fa fa-user-plus mine"></i><br><h3 style="color:#3399cc;font-family:lucida sans;">Admin Registration Area</h3></center>
	<form action="check_admin_register.php" method="post">
	<center>
