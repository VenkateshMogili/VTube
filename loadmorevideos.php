...
if($num_rows>0)
{
	while($r=mysqli_fetch_array($result))
	{
		...
		echo '<tr><td style="padding:10px;"><a href="#" onclick="view_video(\'play.php?video='.$video_code.'\')">';
			...
			echo '<img src="images/video7.png" style="width:100px;height:100px;"><p style="color:magenta;margin-top:-20px;margin-left:60px;z-index:999999;">'.$vtime.'</p></p></td>
...
<li class="loadbutton"><button class="loadmorevideos" data-page=<?php echo $paged+1;?>>Load More</button></li>
<?php
}
endif;
?>