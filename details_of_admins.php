...
while($r=mysqli_fetch_array($sql))
{
	...
	echo "<tr style='color:blue;'><td>".$name."</td><td>".$id."</td><td>".$branch."</td><td>".$year."</td><td>".$class."</td><td>".$gender."</td><td>".$cat."</td><td><a href='del_link.php?cat=users&&link=".$id."'><button class='btn btn-danger'>X</button></a></tr>";
}
echo "</tbody>";
	}
else{
